...
- Single-course default: `<course-slug>-course-expert-lineage`.
- Study mode: `<course-slug>-study-coach-lineage`.
- Practitioner mode: `<course-slug>-practitioner-lineage`.
- Citation mode: `<course-slug>-citation-archive-lineage`.
- Multi-course knowledge base: `<combined-slug>-knowledge-base-lineage`.
- Multi-course domain expert: `<combined-slug>-domain-expert-lineage`.
