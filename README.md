...
<img src="./docs/img/lineage-real-workflow-demo-zh.gif" alt="Lineage 从接收课程材料、自动整理、交付课程 Skill 到开始练习的真实流程演示" width="100%">

演示数据来自仓库内公开合成课程的一次真实运行：1 份文字材料被整理为 18 条有出处的信息、14 项可练能力、14 个练习和 68 个检查任务，最终生成结果通过检查且没有错误。为避免泄露隐私，界面是对真实运行过程的可视化还原，没有使用真实用户账号、本机路径或私人课程内容。
