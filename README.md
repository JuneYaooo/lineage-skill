...
完成[安装](./docs/install.md)后，把学习材料交给支持 Skill 的 AI 助手，并直接用自然语言说明目标即可。你不需要运行项目脚本，也不需要理解内部文件结构。

例如，你可以这样说：

> 请使用 Lineage Skill，把这套课程整理成一个能带我系统练习的学习 Skill。重要结论要能回查出处，并告诉我材料有哪些缺失。

也可以针对已有学习 Skill 直接说：

> 我想真正掌握这套方法。先了解我的目标和基础，再给我一个练习；等我提交第一次尝试后再反馈。

只想查资料时可以说：

> 帮我查一下老师对这个问题的原意，给出对应出处；这次不用安排练习。

想解决现实问题时可以说：

> 请用课程里的方法帮我分析这个真实问题。先让我说明判断和方案，再指出最关键的偏差。
